...
- Test stability: schema and API coverage for trace, RAG evidence, evaluation, regression comparison, run detail, API key security, privacy redaction, ingestion correctness, and timeline pagination
...
## Cleanup Priorities
1. Add evaluation and regression reproducibility metadata before CI usage.
2. Persist regression comparison reports after report identity is stable.
