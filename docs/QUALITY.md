...
- UI quality: Trace Viewer is now organized as an F16.x branch sequence; F16.1 adds the dark Agent Observatory visual system, F16.2 upgrades the timeline into a Trace Spine, and F16.3 structures the inspector around summary, payload, RAG evidence, evaluation metrics, and collapsed raw JSON

## Cleanup Priorities
1. Complete F16.4 Run Navigator Summary API before returning to F17 Retention Cleanup.
2. Implement F17 Retention Cleanup with dry-run and execute modes.
